...
monster1 = Monster.create(name: "Mummy", strength: 6)
monster2 = Monster.create(name: "Zombie", strength: 7)
monster3 = Monster.create(name: "Vampire", strength: 8)
monster4 = Monster.create(name: "Yeti", strength: 6)
monster5 = Monster.create(name: "Witch", strength: 10)
monster6 = Monster.create(name: "Dragon", strength: 2)
monster7 = Monster.create(name: "Ogre", strength: 7)
monster8 = Monster.create(name: "Ghost", strength: 5)
