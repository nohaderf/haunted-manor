...
# monster1 = Monster.create(name: "Ghost", strength: 3)
# monster2 = Monster.create(name: "Zombie", strength: 5)
# monster3 = Monster.create(name: "Vampire", strength: 10)
# MONSTERS IF WE CAN RANDOMIZE
