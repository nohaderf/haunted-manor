...
monster1 = Monster.create(id: 1, name: "Ghost", strength: 3)
monster2 = Monster.create(id: 2, name: "Zombie", strength: 5)
monster3 = Monster.create(id: 3, name: "Vampire", strength: 10)
